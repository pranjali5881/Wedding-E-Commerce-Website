...
export class ProductDetailsComponent implements OnInit {
  ...
  @ViewChild('ingre_qty1') ingre_qty1 : ElementRef;
  ...
  constructor( private route: ActivatedRoute,
    ...
    ngOnInit() {
      ...
      this.http.get("http://localhost:3003/api/product/"+id2).subscribe(posts =>{
    ...
    addTocart()
    {
      ...
      const size = this.ingre_qty1.nativeElement.value;
      ...
      console.log(qty);
      console.log(size);
      const cartItems = new Cart(this.products._id,product_name,product_count,product_size,product_image,product_price,product_total);
