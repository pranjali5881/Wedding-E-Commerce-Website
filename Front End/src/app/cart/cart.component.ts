...
export class CartComponent implements OnInit {
  ...
  placeOrder2()
  {
    ...
    for(let i of this.cart)
    {
    const items =   new Order(i.product_id,i.product_name,i.product_count,i.product_size,i.product_price);
  ...
  let address = "Vasunde";
  //let user = "5eecb6eaa461041c7862bbda";
  ...
  let postData = 
  {
    ...
    this.http.post('http://localhost:3003/api/order/create',postData).subscribe(responseData => {
